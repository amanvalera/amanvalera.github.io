...
/* keep sidebar/footer; just hide the big auto title */
.page__inner-wrap > header{ display:none !important; }

/* let content span edge-to-edge for full-height sections */
...
/* sections that snap (the wrapper prevents the footer from cutting in) */
...
h2{ font-size:clamp(1.4rem,3vw,2rem); color:var(--muted); font-weight:600; margin:0; }
...
<!-- Wrap ALL sections so the theme footer renders after them.
     This wrapper is NOT a scroller; the BODY handles snapping. -->
<div id="home-sections" markdown="0">
