...
<style>
:root{ --masthead-h:64px; --bg:#222; --fg:#f5f5f5; --muted:#bdbdbd; --accent:#9b87f5; --card:#2b2b2b; --maxw:1100px; }

/* keep sidebar/footer, just hide the big auto title */
.page__inner-wrap > header{ display:none !important; }

/* let content span full width/height */
...
.section{
  ...
  scroll-snap-stop:always;                  /* one-per-scroll feel */
